...
.. module:: Melise
    ...
    :synopsis: This module holds the functions developed by Melise Steyn.
.. moduleauthor:: Melise Steyn <msteyn@csir.co.za>
...
class Melise():
    """
        :synopsis: This class contains Melise's functions.
        ...
        .. note::
            ...
            **The `melise###()` functions will return the Dash components that need to be displayed (where # are numbers)**.
    ...
    def i_do_something(whatever_parameters,another_param):
        """
            ...
            >>> Melise.i_do_something("hello",11)
    ...
    def melise(debug=False):
        ...
        >>> Melise.melise("","logging.py, logging:","This is an example log message.")
