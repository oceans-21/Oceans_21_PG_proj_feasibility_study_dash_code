...
.. module:: Nicolene
    ...
    :synopsis: This module holds the functions developed by Nicolene Botha.
.. moduleauthor:: Nicolene Botha <nbotha@csir.co.za>
...
class Nicolene():
    """
        :synopsis: This class contains Nicolene's functions.
        ...
        .. note::
            ...
            **The `nicolene###()` functions will return the Dash components that need to be displayed (where # are numbers)**.
    ...
    def i_do_something(whatever_parameters,another_param):
        """
            ...
            >>> Nicolene.i_do_something("hello",11)
    ...
    def nicolene(debug=False):
        ...
        >>> Nicolene.nicolene("","logging.py, logging:","This is an example log message.")
