...
class Kirodh():
    """
        ...
        .. note::
            ...
            **The `kirodh###()` functions will return the Dash components that need to be displayed (where # are numbers)**.
    ...
    def i_do_something(whatever_parameters,another_param):
        """
            ...
            >>> Kirodh.i_do_something("hello",11)
    ...
    def kirodh(debug=False):
        ...
        >>> Kirodh.kirodh("","logging.py, logging:","This is an example log message.")
