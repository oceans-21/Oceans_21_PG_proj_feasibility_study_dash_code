...
.. module:: Kobie
    ...
    :synopsis: This module holds the functions developed by Kobie Smit.
.. moduleauthor:: Kobie Smits <ksmit@csir.co.za>
...
class Kobie():
    """
        :synopsis: This class contains Kobie's functions.
        ...
        .. note::
            ...
            **The `kobie###()` functions will return the Dash components that need to be displayed (where # are numbers)**.
    ...
    def kobie(debug=False):
        ...
        >>> Kobie.kobie("","logging.py, logging:","This is an example log message.")
