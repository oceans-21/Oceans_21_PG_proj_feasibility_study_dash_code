...
.. moduleauthor:: Chris Mahlathi <cdmahlathi@csir.co.za>
...
class Chris():
    """
        :synopsis: This class contains Chris's functions.
        ...
        .. note::
            ...
            **The `chris###()` functions will return the Dash components that need to be displayed (where # are numbers)**.
    ...
    def chris(debug=False):
        ...
        >>> Chris.chris("","logging.py, logging:","This is an example log message.")
